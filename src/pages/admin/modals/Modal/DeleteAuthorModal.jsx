...
const DeleteAuthorModal = ({show, setShow, nickname, yesClickHandler, requestIsSending, userShow}) => {
  return (
      <Modal show={show} setShow={setShow}>
        ...
        <div className={s.buttons}>
          <button disabled={requestIsSending} onClick={()=>yesClickHandler(userShow)} className={s.yesBtn}>{requestIsSending ?
